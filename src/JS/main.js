...
import laptop_footer from "./components/laptop_footer.js";
import fixedbtn from "./components/fixedbtn.js";
Rootwriter(header,recommended,feature,trending,mostGifted,laptop_footer,fixedbtn);
scroll();
menuBar();
searchMenu();
hamburgerMenu();

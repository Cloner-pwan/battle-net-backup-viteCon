let navbar = `  <div id="headerContainer" class="w-full h-[580px] flex justify-center">
    <header id="header" class="w-[1632px] h-full bg-[#15171e]">
      <div class="menuBar w-full h-[72px] flex px-2 relative items-center">
        ...
        <div id="hamburgerMenuItems" class="hamburgerMenuItems sm:w-[480px] md:max-w-[450px] h-full bg-red-400 group-hover:sm:flex group-hover:md:flex lg:hidden fixed top-0 left-[-100%] z-[9999] duration-500">
